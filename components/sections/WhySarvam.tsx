 ...
 *
 * The quote panel is navy: one small dark block inside a light section,
      ...
      <div className="container-page">
        <div className="grid gap-16 lg:grid-cols-[minmax(0,1.05fr)_minmax(0,0.95fr)] lg:gap-24">
          ...
          <Reveal className="lg:pt-24">
            <figure className="bg-navy grain rounded-panel relative isolate overflow-hidden p-10 lg:p-14">
              <blockquote className="font-display text-paper text-display-md italic">
                {WHY_QUOTE.quote}
              </blockquote>

              <figcaption className="text-eyebrow text-paper/45 mt-10 flex items-center gap-3.5 uppercase">
                <span aria-hidden className="accent-rule shrink-0" />
                {WHY_QUOTE.attribution}
              </figcaption>

              <p className="border-paper/12 text-paper/60 mt-12 border-t pt-10 text-sm">
